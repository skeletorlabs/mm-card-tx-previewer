...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (parsedAmount > 0) {
      ...
      const usdcWithBuffer = usdc + buffer;
      ...
      <main className="flex flex-col gap-6 items-center">
        <div className="flex flex-col items-center gap-2">
          ...
          {/* <h1 className="text-2xl font-bold pb-8 flex items-center gap-3 text-orange-400 relative box-shadow">
            ...
            <div className="absolute top-[4px] left-[3px] text-2xl font-bold pb-10 flex items-center gap-3 z-0 text-amber-900">
              <svg
                data-slot="icon"
                fill="none"
                strokeWidth="1.5"
        ...
        <div className="flex flex-col justify-center w-full">
          <label htmlFor="amount">Amount to spend in BRL</label>
          <input
            type="text"
            id="amount"
