...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center pt-[5%] relative">
      <main className="flex flex-col gap-10 items-center">
        <div className="flex flex-col items-center gap-2">
          <div className="flex justify-between w-full mb-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col h-full justify-center">
                ...
                <span className="text-xs font-sans font-semibold tracking-[-0.5px] ml-[1px]">
                  Preview
                </span>
              </div>
            </div>
          ...
          <Card
            ...
            balance={balance}
          />
          <div className="flex items-center justify-between w-full text-sm font-thin tracking-tighter">
            <span className="">
      ...
      <footer className="w-full p-4 text-center text-white/70">
        <div className="flex items-center justify-center gap-1 text-xs font-thin">
